-- Scene Loader Feature Implementation
-- Handles loading and managing predefined scenes
...
function SceneLoader:_load_predefined_scenes()
  return {
...
function SceneLoader:list_scenes(category)
  local scenes = {}
...
-- Get scene by ID
function SceneLoader:get_scene_by_id(scene_id)
  for _, scene in ipairs(self._predefined_scenes) do
...
function SceneLoader:get_predefined_scenes()
